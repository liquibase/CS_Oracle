...
--changeset amy_smith:FT_01 labels:"v2026.1.24,ABC-0987" runWith:sqlplus
CREATE TABLE CAPS.COLORS_101 (ID NUMBER(*, 0), COLOR VARCHAR2(20 BYTE));
--rollback drop table CAPS.COLORS_101;

--changeset amy_smith:FT_01_1 labels:"v2026.1.24,ABC-0987" runWith:sqlplus
...
--changeset amy_smith:FT_01_2 labels:"v2026.1.24,ABC-0987" runWith:sqlplus
SELECT * FROM CAPS.COLORS_101;
--rollback SELECT * FROM CAPS.COLORS_101;

--changeset amy_smith:FT_01_3 labels:"v2026.1.24,ABC-0987" runWith:sqlplus
